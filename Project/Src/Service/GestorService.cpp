...
void GestorService::registarCamiao(string matricula, float capacidade) {
...
void GestorService::registarCamionista(string nome) {
...
void GestorService::registarCarga(float peso, string destino) {
...
void GestorService::listarTodos() {
    cout << "\n=== Camioes ===\n";
...
bool GestorService::atribuirCamionista(string matriculaCamiao, string nomeCamionista) {
...
void GestorService::removerCamionista(string nome) {
...
void GestorService::removerCarga(int indice) {
...
void GestorService::removerCamiao(string matricula) {
...
void GestorService::listarRotasConcluidas() {
